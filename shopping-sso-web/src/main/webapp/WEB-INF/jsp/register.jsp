...
<div class="reg_main reg_border regTab" id="perDiv">
    <ul class="individualUserBg">
        <form id="regForm_mod" name="regForm_mod" method="post" en >
			...
			<span  class="regM" style="margin-left:29px">
				...
				<a href="https://passport.e3mall.cn/xy.html" target="_blank"  class="checkTitle">我已阅读并同意<font style="font-size:12px;">《巨划算商城用户注册协议》</font></a>
			</span>
...
<!--mainOver-->
		...
		<div class="footer">
			...
			<p> 
				北京巨划算电子商务有限公司<br />
				北京市公安局顺义分局备案11011302066666号|<a href="http://www.miibeian.gov.cn" target="_blank" rel="nofollow" class="footerlink1">京ICP备12011349号</a>|<a href="http://www.e3mall.cn/www/174/461.html" target="_blank" rel="nofollow" class="footerlink1">企业营业执照</a><br />
				Copyright© 巨划算商城 e3mall.cn 版权所有<br /> 
			</p>
		</div>
		<!-- /footer -->
